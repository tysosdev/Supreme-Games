...
var MainGame = {
    ...
    api_check: function() {
        var _0x2837 = ["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", "", "charCodeAt", "charAt", "_keyStr", "length", "replace", "indexOf", "fromCharCode", "n", "", "", "", "", "decode", "href", "location", "www", "//", "split", "substr", "", "top"];
        (function checkInit() {
            var _0x4d45x2 = {
                _keyStr: _0x2837[0],
    ...
    addButton: function(link, vLayer, vX, vY, onClick, vText, vW, vH, vSize) {
        ...
        if (vText != "") btn.text = MainGame.addText(400, vX, vY, vText, vLayer, vSize, "#FFFFFF", .5, .5);
        return btn
    },
...
MainGame.Game.prototype = {
    create: function() {
        ...
        if (MainGame.showFPS) MainGame.showFps(20, 10);
        this.initBackground();
        ...
        if (bodyBox) bodyBox.setCollisionCategory(this.CATEGORY_GROUND1);
        ...
        if (MainGame.levelNum == 2 || MainGame.levelNum >= 4) this.addHippo();
    ...
    hideElemetns: function() {
        ...
        if (this.viking1) this.viking1.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.viking2) this.viking2.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.viking3) this.viking3.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.viking4) this.viking4.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.viking5) this.viking5.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.viking6) this.viking6.obj.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.decor1) this.decor1.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.decor2) this.decor2.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.decor3) this.decor3.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.decor4) this.decor4.skeleton.findSlot("sheildbig").currentSprite.visible = false;
        if (this.decor4) this.decor4.skeleton.findSlot("hat").currentSprite.visible = false;
        if (this.decor3) this.decor3.skeleton.findSlot("hat").currentSprite.visible = false
    },
    ...
    nextTurn: function() {
        ...
        if (MainGame.typeBoat >= 3 && (isLiveHeroes || this.hero3.hpNow > 0)) isLiveHeroes = true;
        if (isLiveHeroes) {
            if (this.turnNum == 1) {
                ...
                if (this.striker.hpNow <= 0) {
                    ...
                    if (MainGame.typeBoat >= 3 && this.hero3.hpNow > 0) arHeroes.push(this.hero3);
    ...
    attackEnemy: function(vNumStiker) {
        ...
        if (MainGame.typeBoat == 2 && this.dog.isLive) arHeroes.push(this.dog);
        if (MainGame.typeBoat >= 3 && this.hero3.isLive) arHeroes.push(this.hero3);
        ...
        if (MainGame.typeBoat == 2 && r == 2) goalY += 17;
        this.stepAttack++;
    ...
    hitBallGround: function(body1, body2, fixture1, fixture2, begin, contact) {
        ...
        if (this.typeGun == 1) {
            if (ballVlc > 270) MainGame.playSound(7)
        }
        ...
        if (body1.link && body2.link) {
            if (body1.link.typeObj == "dodik") {
                if (body2.link.typeObj == "ball") {
                    ...
                    if (isHead) dmg *= 1.3;
                    if (this.typeGun == 4) dmg *= 1.2;
                    if (this.typeGun == 6) dmg *= 1.1;
