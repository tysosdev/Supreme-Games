...
function _dmFacebookAccessToken(callback, lua_state) {
    try {
...
function _dmFacebookDisableEventUsage() {
...
function _dmFacebookEnableEventUsage() {
    console.error("Limiting Facebook Analytics is not supported for Canvas")
}

function _dmFacebookInitialize(app_id, version) {
    try {
        FB.init({
...
function _dmFacebookLoginWithPermissions(state_open, state_closed, state_failed, permissions, callback, thread) {
    try {
        var opts = {
            scope: UTF8ToString(permissions)
        };
            ...
            if (error == 0 && response.authResponse) {
                ...
                window._dmFacebookUpdatePermissions(function(_error, _permissions) {
                    if (_error == 0) {
                        ...
                        wasmTable.get(callback)(thread, state_open, 0, permissionsbuf)
                    } else {
                        var errbuf = allocate(intArrayFromString(_error), "i8", ALLOC_STACK);
                        wasmTable.get(callback)(thread, state_failed, errbuf, 0)
                    }
                })
            } else if (error != 0) {
                var errbuf = allocate(intArrayFromString(error), "i8", ALLOC_STACK);
                wasmTable.get(callback)(thread, state_closed, errbuf, 0)
            } else {
...
function _dmFacebookPostEvent(event, value_to_sum, keys, values) {
    var params = {};
    try {
...
function _dmFacebookShowDialog(params, mth, callback, lua_state) {
    ...
    try {
        FB.ui(par, function(response) {
            ...
            if (e == 0) {
                ...
                wasmTable.get(callback)(lua_state, res_buf, e)
            } else {
                var error = allocate(intArrayFromString(e), "i8", ALLOC_STACK);
                wasmTable.get(callback)(lua_state, 0, error)
            }
        })
    } catch (e) {
...
var asmLibraryArg = {
    "eg": _JsToDef_RegisterCallbacks,
    "dg": _JsToDef_RemoveCallbacks,
    "b": ___assert_fail,
    "cg": ___clock_gettime,
    "bg": ___gmtime_r,
    "ag": ___localtime_r,
    "_f": ___sys__newselect,
    "Rf": ___sys_dup2,
    "Wf": ___sys_dup3,
    "h": ___sys_fcntl64,
    "Sf": ___sys_ioctl,
    ...
    "Of": _clock,
    "Nf": _difftime,
    "Mf": _dmDeviceJSFreeBufferSlots,
    "Lf": _dmDeviceJSOpen,
    "Kf": _dmDeviceJSQueue,
    "Jf": _dmFacebookAccessToken,
    "If": _dmFacebookDisableEventUsage,
    "Hf": _dmFacebookDoLogout,
    "Gf": _dmFacebookEnableEventUsage,
    "Ff": _dmFacebookInitialize,
    "Ef": _dmFacebookLoginWithPermissions,
    "Df": _dmFacebookPostEvent,
    "Cf": _dmFacebookShowDialog,
    "Bf": _dmGetDeviceSampleRate,
    "Af": _dmScriptHttpRequestAsync,
    "zf": _dmSysGetApplicationPath,
    "yf": _dmSysGetUserAgent,
    "xf": _dmSysGetUserPersistentDataRoot,
    "wf": _dmSysGetUserPreferredLanguage,
    "vf": _dmSysOpenURL,
    "uf": _emscripten_asm_const_int,
    "tf": _emscripten_cancel_main_loop,
    "N": _emscripten_get_now,
    "sf": _emscripten_glActiveTexture,
    "rf": _emscripten_glAttachShader,
    "qf": _emscripten_glBeginQueryEXT,
    "pf": _emscripten_glBindAttribLocation,
    "of": _emscripten_glBindBuffer,
    "nf": _emscripten_glBindFramebuffer,
    "mf": _emscripten_glBindRenderbuffer,
    "lf": _emscripten_glBindTexture,
    "kf": _emscripten_glBindVertexArrayOES,
    "jf": _emscripten_glBlendColor,
    "hf": _emscripten_glBlendEquation,
    "gf": _emscripten_glBlendEquationSeparate,
    "ff": _emscripten_glBlendFunc,
    "ef": _emscripten_glBlendFuncSeparate,
    "df": _emscripten_glBufferData,
    "cf": _emscripten_glBufferSubData,
    "bf": _emscripten_glCheckFramebufferStatus,
    "af": _emscripten_glClear,
    "$e": _emscripten_glClearColor,
    "_e": _emscripten_glClearDepthf,
    "Ze": _emscripten_glClearStencil,
    "Ye": _emscripten_glColorMask,
    "Xe": _emscripten_glCompileShader,
    "We": _emscripten_glCompressedTexImage2D,
    "Ve": _emscripten_glCompressedTexSubImage2D,
    "Ue": _emscripten_glCopyTexImage2D,
    "Te": _emscripten_glCopyTexSubImage2D,
    "Se": _emscripten_glCreateProgram,
    "Re": _emscripten_glCreateShader,
    "Qe": _emscripten_glCullFace,
    "Pe": _emscripten_glDeleteBuffers,
    "Oe": _emscripten_glDeleteFramebuffers,
    "Ne": _emscripten_glDeleteProgram,
    "Me": _emscripten_glDeleteQueriesEXT,
    "Le": _emscripten_glDeleteRenderbuffers,
    "Ke": _emscripten_glDeleteShader,
    "Je": _emscripten_glDeleteTextures,
    "Ie": _emscripten_glDeleteVertexArraysOES,
    "He": _emscripten_glDepthFunc,
    "Ge": _emscripten_glDepthMask,
    "Fe": _emscripten_glDepthRangef,
    "Ee": _emscripten_glDetachShader,
    "De": _emscripten_glDisable,
    "Ce": _emscripten_glDisableVertexAttribArray,
    ...
    "xe": _emscripten_glDrawElementsInstancedANGLE,
    "we": _emscripten_glEnable,
    "ve": _emscripten_glEnableVertexAttribArray,
    "ue": _emscripten_glEndQueryEXT,
    "te": _emscripten_glFinish,
    "se": _emscripten_glFlush,
    "re": _emscripten_glFramebufferRenderbuffer,
    "qe": _emscripten_glFramebufferTexture2D,
    "pe": _emscripten_glFrontFace,
    "oe": _emscripten_glGenBuffers,
    "ne": _emscripten_glGenFramebuffers,
    "me": _emscripten_glGenQueriesEXT,
    "le": _emscripten_glGenRenderbuffers,
    "ke": _emscripten_glGenTextures,
    "je": _emscripten_glGenVertexArraysOES,
    "ie": _emscripten_glGenerateMipmap,
    "he": _emscripten_glGetActiveAttrib,
    "ge": _emscripten_glGetActiveUniform,
    "fe": _emscripten_glGetAttachedShaders,
    "ee": _emscripten_glGetAttribLocation,
    "de": _emscripten_glGetBooleanv,
    "ce": _emscripten_glGetBufferParameteriv,
    "be": _emscripten_glGetError,
    "ae": _emscripten_glGetFloatv,
    "$d": _emscripten_glGetFramebufferAttachmentParameteriv,
    "_d": _emscripten_glGetIntegerv,
    "Zd": _emscripten_glGetProgramInfoLog,
    "Yd": _emscripten_glGetProgramiv,
    "Xd": _emscripten_glGetQueryObjecti64vEXT,
    "Wd": _emscripten_glGetQueryObjectivEXT,
    "Vd": _emscripten_glGetQueryObjectui64vEXT,
    "Ud": _emscripten_glGetQueryObjectuivEXT,
    "Td": _emscripten_glGetQueryivEXT,
    "Sd": _emscripten_glGetRenderbufferParameteriv,
    "Rd": _emscripten_glGetShaderInfoLog,
    "Qd": _emscripten_glGetShaderPrecisionFormat,
    "Pd": _emscripten_glGetShaderSource,
    ...
    "Kd": _emscripten_glGetUniformLocation,
    "Jd": _emscripten_glGetUniformfv,
    "Id": _emscripten_glGetUniformiv,
    "Hd": _emscripten_glGetVertexAttribPointerv,
    ...
    "ld": _emscripten_glScissor,
    "kd": _emscripten_glShaderBinary,
    "jd": _emscripten_glShaderSource,
    "id": _emscripten_glStencilFunc,
    "hd": _emscripten_glStencilFuncSeparate,
    "gd": _emscripten_glStencilMask,
    "fd": _emscripten_glStencilMaskSeparate,
    "ed": _emscripten_glStencilOp,
    "dd": _emscripten_glStencilOpSeparate,
    "cd": _emscripten_glTexImage2D,
    "bd": _emscripten_glTexParameterf,
    "ad": _emscripten_glTexParameterfv,
    "$c": _emscripten_glTexParameteri,
    "_c": _emscripten_glTexParameteriv,
    "Zc": _emscripten_glTexSubImage2D,
    "Yc": _emscripten_glUniform1f,
    "Xc": _emscripten_glUniform1fv,
    "Wc": _emscripten_glUniform1i,
    "Vc": _emscripten_glUniform1iv,
    "Uc": _emscripten_glUniform2f,
    "Tc": _emscripten_glUniform2fv,
    "Sc": _emscripten_glUniform2i,
    "Rc": _emscripten_glUniform2iv,
    ...
    "Gc": _emscripten_glUniformMatrix4fv,
    ...
    "rc": _emscripten_pause_main_loop,
    ...
    "y": _glDeleteShader,
    "ta": _glDeleteTextures,
    "ec": _glDepthFunc,
    "dc": _glDepthMask,
    "cc": _glDisable,
    "bc": _glDisableVertexAttribArray,
    "ac": _glDrawArrays,
    "$b": _glDrawElements,
    "_b": _glEnable,
    "sa": _glEnableVertexAttribArray,
    "Zb": _glFlush,
    "U": _glFramebufferRenderbuffer,
    "Yb": _glFramebufferTexture2D,
    "ra": _glGenBuffers,
    "Xb": _glGenFramebuffers,
    "I": _glGenRenderbuffers,
    "Wb": _glGenTextures,
    "Vb": _glGetActiveUniform,
    ...
    "na": _glUseProgram,
    "ma": _glVertexAttribPointer,
    "Jb": _glViewport,
    "Ib": _glfwAccelerometerEnable,
    "Hb": _glfwCloseWindow,
    "Gb": _glfwGetAcceleration,
    "la": _glfwGetDefaultFramebuffer,
    ...
    "Bb": _glfwGetKey,
    "k": _glfwGetMouseButton,
    "Ab": _glfwGetMousePos,
    "zb": _glfwGetMouseWheel,
    "Q": _glfwGetProcAddress,
    "yb": _glfwGetWindowParam,
    "xb": _glfwGetWindowRefreshRate,
    "ka": _glfwGetWindowSize,
    "wb": _glfwIconifyWindow,
    "vb": _glfwInitJS,
    "ub": _glfwOpenWindow,
    "P": _glfwOpenWindowHint,
    "tb": _glfwPollEvents,
    "sb": _glfwResetKeyboard,
    "rb": _glfwSetCharCallback,
    "qb": _glfwSetGamepadCallback,
    "pb": _glfwSetMarkedTextCallback,
    "ob": _glfwSetTouchCallback,
    "nb": _glfwSetWindowCloseCallback,
    "mb": _glfwSetWindowFocusCallback,
    "lb": _glfwSetWindowIconifyCallback,
    "ja": _glfwSetWindowSize,
    "kb": _glfwSetWindowSizeCallback,
    "ia": _glfwShowKeyboard,
    "jb": _glfwSwapBuffers,
...
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function() {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = Module["asm"]["hg"]).apply(null, arguments)
};
var _main = Module["_main"] = function() {
    return (_main = Module["_main"] = Module["asm"]["ig"]).apply(null, arguments)
};
var _free = Module["_free"] = function() {
    return (_free = Module["_free"] = Module["asm"]["jg"]).apply(null, arguments)
};
var _malloc = Module["_malloc"] = function() {
    return (_malloc = Module["_malloc"] = Module["asm"]["kg"]).apply(null, arguments)
};
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function() {
    return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = Module["asm"]["lg"]).apply(null, arguments)
};
...
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function() {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = Module["asm"]["ng"]).apply(null, arguments)
};
var ___errno_location = Module["___errno_location"] = function() {
    return (___errno_location = Module["___errno_location"] = Module["asm"]["og"]).apply(null, arguments)
};
var _htons = Module["_htons"] = function() {
    return (_htons = Module["_htons"] = Module["asm"]["pg"]).apply(null, arguments)
};
var _ntohs = Module["_ntohs"] = function() {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["qg"]).apply(null, arguments)
};
var _JSWriteDump = Module["_JSWriteDump"] = function() {
    return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["rg"]).apply(null, arguments)
};
var __get_tzname = Module["__get_tzname"] = function() {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["sg"]).apply(null, arguments)
};
var __get_daylight = Module["__get_daylight"] = function() {
    return (__get_daylight = Module["__get_daylight"] = Module["asm"]["tg"]).apply(null, arguments)
};
var __get_timezone = Module["__get_timezone"] = function() {
    return (__get_timezone = Module["__get_timezone"] = Module["asm"]["ug"]).apply(null, arguments)
};
var stackSave = Module["stackSave"] = function() {
    return (stackSave = Module["stackSave"] = Module["asm"]["vg"]).apply(null, arguments)
};
var stackRestore = Module["stackRestore"] = function() {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["wg"]).apply(null, arguments)
};
var stackAlloc = Module["stackAlloc"] = function() {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["xg"]).apply(null, arguments)
};
var _setThrew = Module["_setThrew"] = function() {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["yg"]).apply(null, arguments)
};
